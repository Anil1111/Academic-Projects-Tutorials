...
function combine1(inp1: number | string, inp2: number | string, resultConversion: 'as-num'|'as-string'){
  let result;
...
function combine2(inp1: Combinable, inp2: Combinable, resultConversion: ConversionDescriptor){
  let result;
