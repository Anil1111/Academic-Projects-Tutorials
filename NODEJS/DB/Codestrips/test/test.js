...
const Structured = require('structured'); //for the first test module
const fs = require('fs');
const code = fs.readFileSync('app.js', 'utf8'); //for the first test module

const app = require('../app'); //for running the get and post requests from app
const seed = require('./seed.js'); //to start seeding data into the test.sqlite

const prodDb = new sqlite3.Database('./db.sqlite'); //The Db as set by app.js
const testDb = new sqlite3.Database(process.env.TEST_DATABASE); //The DB as set by the TesT module
