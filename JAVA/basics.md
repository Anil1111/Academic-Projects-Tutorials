...
used + to add! - int numPicturesOfCats = 60 + 24;
...
eg:     ArrayList<String> toDoList = new ArrayList<String>();
...
Logic Errors
These types of errors which provide incorrect output, but appears to be error-free, are called logic errors. Logic errors occur when there is a design flaw in your program